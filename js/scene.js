...
const UI={
  ...
  awardsSub:{id:"Tiga pengakuan yang tidak bisa dibeli, dan satu acara yang saya isi sekaligus saya selenggarakan.",
             en:"Three recognitions that cannot be bought, and one event I both ran and taught."},
  ...
  roadSub:{id:"Tiga tonggak yang saya tetapkan sendiri — dan apa yang sudah berjalan sekarang.",
           en:"Three milestones I set for myself — and what is already running."},
  ...
  cvBtn:{id:"Lihat sertifikasi",en:"View certifications"},
  mailBtn:{id:"Kirim pesan",en:"Send a message"},
  cvDownload:{id:"Download CV",en:"Download CV"},
  cvChoose:{id:"Pilih versi CV",en:"Choose a CV version"},
  cvIndonesia:{id:"CV Bahasa Indonesia",en:"Indonesian CV"},
  cvEnglish:{id:"CV Bahasa Inggris",en:"English CV"},
